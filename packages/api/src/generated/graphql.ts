...
export type ResolversTypes = {
  ...
  LinkSubmissionsResult: ResolverTypeWrapper<
    Omit<LinkSubmissionsResult, 'items'> & {
      items: Array<ResolversTypes['LinkSubmission']>
    }
  >
...
export type ResolversParentTypes = {
  ...
  LinkSubmissionsResult: Omit<LinkSubmissionsResult, 'items'> & {
    items: Array<ResolversParentTypes['LinkSubmission']>
  }
  Me: Me
...
export type IssueResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['Issue'] =
...
export type LinkSubmissionsResultResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['LinkSubmissionsResult'] =
    ResolversParentTypes['LinkSubmissionsResult'],
> = {
  items?: Resolver<
    Array<ResolversTypes['LinkSubmission']>,
    ParentType,
    ContextType
  >
...
> = {
  addLinksToTopic?: Resolver<
    Maybe<ResolversTypes['Topic']>,
    ParentType,
    ContextType,
    RequireFields<MutationAddLinksToTopicArgs, 'linkId' | 'topicId'>
  >
  createIssue?: Resolver<
    Maybe<ResolversTypes['Issue']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateIssueArgs, 'number' | 'published' | 'title'>
  >
  createLink?: Resolver<
    Maybe<ResolversTypes['Link']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateLinkArgs, 'url'>
  >
  createSubmissionLink?: Resolver<
    Maybe<ResolversTypes['LinkSubmission']>,
    ParentType,
    ContextType,
    RequireFields<
      MutationCreateSubmissionLinkArgs,
      'description' | 'email' | 'name' | 'title' | 'url'
    >
  >
  createSubscriber?: Resolver<
    Maybe<ResolversTypes['Subscriber']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateSubscriberArgs, 'email' | 'name'>
  >
  createTopic?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationCreateTopicArgs,
      'issueId' | 'issue_comment' | 'title'
    >
  >
  ...
  publishEmailDraft?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationPublishEmailDraftArgs, 'id'>
  >
  updateIssue?: Resolver<
    Maybe<ResolversTypes['Issue']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateIssueArgs, 'id'>
  >
  updateLink?: Resolver<
    Maybe<ResolversTypes['Link']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateLinkArgs, 'id' | 'title'>
  >
  ...
  >
  updateTopicWhenIssueDeleted?: Resolver<
    Maybe<ResolversTypes['Topic']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateTopicWhenIssueDeletedArgs, 'id'>
  >
}
...
> = {
  ...
  linkSubmissions?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QueryLinkSubmissionsArgs>
  >
  me?: Resolver<Maybe<ResolversTypes['Me']>, ParentType, ContextType>
  unassignedLinks?: Resolver<
    Array<ResolversTypes['Link']>,
    ParentType,
    ContextType
  >
