...
class PositionUpdaterBase extends Component<PositionUpdaterProps, PositionUpdaterState> {
...
`)(PositionUpdaterBase as any) as React.ComponentType<{ refresh?: () => void; topicId?: string; topicIndex?: number; position?: number; topics?: TopicData[] }>
...
export default function Topic({ topic, topicIndex, topics, refresh }: TopicProps) {
  return (
